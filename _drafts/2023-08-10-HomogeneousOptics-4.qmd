...
The (virtual) image generated by the microscope will be 250 mm to the left of the exit pupil, so that it appears at the eye's near point.  We anticipate this will coincide with the image of the field stop (if the engineer was following common practice.)
...
To find the intermediate image plane, we need to project the image plane *backwards* through the eyepiece.  To go backwards, we just need the matrix inverse:
