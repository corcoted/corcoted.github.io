...
[Part 2 is here.](/posts/2022-07-01-HomogeneousOptics-2.qmd)
...
Then the new _a_ and _b_ coefficients become the cosines of the angles between the axes and the line and the new _c_ value gives the (signed) distance from the origin to the line.
With this normalization, the angle _&theta;_ between any two lines can be calculated easily: $\theta=\arccos(a_1a_2+b_1b_2)$ (proven by applying some trig identities).
...
_[Continued in Part 2](/posts/2022-07-01-HomogeneousOptics-2.qmd)_
