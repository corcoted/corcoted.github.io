...
![The equation of an oriented line. In this example, _a_ and _b_ > 0 and _c_<0.](/assets/figs/2022-optics/line.svg){ alt-text="a line in 2D" }
...
![The ABCD matrices.  The incoming ray _r_ is transformed into the outgoing ray _r'_. Note that the outgoing coordinate system is different than the incoming coordinate system.  We'll address this in the next blog post.](/assets/figs/2022-optics/ABCD.svg){ alt-text="Ray transfer matrix schematic"}
